...
# DNX-only image: build only the broadcom-dnx flavor (drop XGS primary + legacy-th)
$(SONIC_ONE_IMAGE)_MACHINE = broadcom-dnx
...
$(SONIC_ONE_IMAGE)_LAZY_BUILD_INSTALLS = $(BRCM_DNX_OPENNSL_KERNEL)
