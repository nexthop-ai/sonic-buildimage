...
class Adm1266PlatformSpecMock:
    pddf_plugin_data = {
        "DPM": {
            "dpm-mock": {
                "dpm_signals": {
                    "2": 2,   # PDIO bit 1 -> Fault code bit 2
                    "15": 0,  # PDIO bit 14 -> Fault code bit 0
                    "16": 1   # PDIO bit 15 -> Fault code bit 1
                },
                "dpm_table": {
                    "0": "",
...
def chassis(mock_pddf_data):
    ...
    # Mock Adm1266PlatformSpec import so Adm1266 uses our mock
    adm1266_platform_spec_module_mock = Mock()
    adm1266_platform_spec_module_mock.Adm1266PlatformSpec = Adm1266PlatformSpecMock
    sys.modules["sonic_platform.adm1266_platform_spec"] = adm1266_platform_spec_module_mock

    # Mock ADM1266 import so Chassis uses our mock
    adm1266_module_mock = Mock()
    adm1266_module_mock.Adm1266 = Adm1266Mock
    sys.modules["sonic_platform.adm1266"] = adm1266_module_mock
