...
$(NEXTHOP_COMMON_PLATFORM_MODULE)_WHEEL_DEPENDS += $(NEXTHOP_UTILS_WHL)
...
# NH-4210
NEXTHOP_4210_PLATFORM_MODULE = sonic-platform-nexthop-4210_1.0_amd64.deb
$(NEXTHOP_4210_PLATFORM_MODULE)_PLATFORM = nexthop-4210
$(eval $(call add_extra_package,$(NEXTHOP_COMMON_PLATFORM_MODULE),$(NEXTHOP_4210_PLATFORM_MODULE)))

NEXTHOP_4210_R0021_PLATFORM_MODULE = sonic-platform-nexthop-4210-r0021_1.0_amd64.deb
$(NEXTHOP_4210_R0021_PLATFORM_MODULE)_PLATFORM = x86_64-nexthop_4210-r0021
