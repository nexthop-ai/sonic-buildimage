...
LIBSAI_AGERA2_VERSION = 4.1.0-1
LIBSAI_AGERA2_BRANCH_NAME = REL_4.1

<<<<<<< HEAD
LIBSAI_AGERA2_URL_PREFIX = "$(BUILD_PUBLIC_URL)/sai/bcmpai/$(LIBSAI_AGERA2_BRANCH_NAME)/$(LIBSAI_AGERA2_VERSION)"
=======
LIBSAI_AGERA2_URL_PREFIX = "https://nh-custom-sai.s3.us-east-2.amazonaws.com/pai_v1"
...
>>>>>>> c2adedad2 (NOS-10859: Bump PAI version to 4.1 (#6355))
...
$(DOCKER_GBSYNCD_AGERA2)_LOAD_DOCKERS += $(DOCKER_CONFIG_ENGINE_TRIXIE)

$(DOCKER_GBSYNCD_AGERA2)_DBG_DEPENDS += $($(DOCKER_CONFIG_ENGINE_TRIXIE)_DBG_DEPENDS)

$(DOCKER_GBSYNCD_AGERA2)_DBG_IMAGE_PACKAGES = $($(DOCKER_CONFIG_ENGINE_TRIXIE)_DBG_IMAGE_PACKAGES)

SONIC_DOCKER_IMAGES += $(DOCKER_GBSYNCD_AGERA2)
SONIC_TRIXIE_DOCKERS += $(DOCKER_GBSYNCD_AGERA2)
SONIC_INSTALL_DOCKER_IMAGES += $(DOCKER_GBSYNCD_AGERA2)

SONIC_DOCKER_DBG_IMAGES += $(DOCKER_GBSYNCD_AGERA2_DBG)
SONIC_TRIXIE_DBG_DOCKERS += $(DOCKER_GBSYNCD_AGERA2_DBG)
...
$(DOCKER_GBSYNCD_AGERA2)_DEPENDS += $(SYNCD) $(LIBSAI_AGERA2) $(SSWSYNCD)
