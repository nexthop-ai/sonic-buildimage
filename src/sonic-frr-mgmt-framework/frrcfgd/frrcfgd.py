...
<<<<<<< HEAD
=======
                      ('gr_select_defer_time',                          '{no:no-prefix}bgp graceful-restart select-defer-time {}'),
                      ('llgr_stale_time',                               '{no:no-prefix}bgp long-lived-graceful-restart stale-time {}'),
>>>>>>> d8c8041df (NOS-8575: Sonic config option to set BGP graceful-restart select-defer-time (#5190))
