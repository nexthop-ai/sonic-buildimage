...
<<<<<<< HEAD
=======
        # By default BGP log-neighbor-changes is enabled
        if not self.directory.path_exist(self.db_name, self.table_name, "log_nbr_state_changes"):
            self.directory.put(self.db_name, self.table_name, "log_nbr_state_changes", self.LOG_NBR_DEFAULTS)
